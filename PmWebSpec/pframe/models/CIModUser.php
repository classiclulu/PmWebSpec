    ...
    public function notifyViaEmail($data) {
       //print_r($data);exit;
        ...
        $msg = "<p style='font-family: arial; font-size: 13px;'> Dear All,<br/><br/> A New Directory Request Has Been Submitted By ".$name." ! <br/><br/>
                ...
                <b style='background-color:#ffec0d;'> Note:</b>&nbsp;<i>This is a Do-Not-Reply Automated Mail Generated By System. Please, Reach Out To <a href='mailto:name@domain.com,?subject=PKMS%20Directory%20Structure%20Request%20Form%20Submission'>name@domain.com</a>
                If You Need Any Assistance. </i></span></p>";
        
        $this->email->clear();
        $this->email->initialize($config);      
        $this->email->from("name@domain.com", "PMWebSpec Update"); 
        $this->email->subject("PKMS Directory Structure Request");
        ...
        if ((base_url() == 'https://pmwebspec-ci-dev.web-dev.bms.com/') || (base_url() == 'http://localhost/') || (base_url() == 'https://pmwebspec-dev.web-dev.bms.com/') || (base_url() == 'https://pmwebspec-demo-dev.web-dev.bms.com/') || (base_url() == 'https://pmwebspec-kuldeep-dev.web-dev.bms.com/')){
            $recipients =  array(
            "name@domain.com",);
        }
