...
<div class="Section1">
    ...
    <table border="1">
        <tr  nobr="true">
            <th style="width: 8%;word-wrap: break-word;">Study</th>
            <th style="width: 8%;word-wrap: break-word;">Statistician</th>
            <th style="width: 18%;word-wrap: break-word;">level0</th>
            <th style="width: 18%;word-wrap: break-word;">level1/SDTM</th>
            <th style="width: 20%;word-wrap: break-word;">level2</th>
            <th style="width: 30%;word-wrap: break-word;">Format</th>
        </tr>';
    ...
    foreach ($data['clinical_data'] as $arr) {
        $htmlContent .= '<tr>
            <td style="font-size:13px;word-wrap: break-word;">' . chunk_split($arr['study'],15,"<br>\n") . '</td>
            <td style="font-size:13px;word-wrap: break-word;">' . chunk_split($arr['statistician'],15,"\n\r") . '</td>
            <td style="font-size:13px;word-wrap: break-word;">' . chunk_split($arr['level0'],15,"\n\r") . '</td>
            <td style="font-size:13px;word-wrap: break-word;">' . chunk_split($arr['level1'],15,"\n\r") . '</td>
            <td style="font-size:13px;word-wrap: break-word;">' . chunk_split($arr['level2'],15,"\n\r") . '</td>
            <td style="font-size:13px;word-wrap: break-word;">' . $arr['format'] . '</td>
            </tr>';
    }
...
';
    ...
    foreach ($data['derivations'] as $arr) {
        ...
        $htmlContent .= '<tr>
            ...
            <td style="font-size:13px;">' . htmlspecialchars($arr['algorithm']) . '</td>
        </tr>';
    }
    ...
    $file_name = $data['spec_id'].'_'.$data['dataset_name'].'_v'.$data['version_id'].'_'.'docx_spec';
    $htd->createDoc($htmlContent, $file_name);
    $htd->createDoc($htmlContent,$file_name, 1);
}
