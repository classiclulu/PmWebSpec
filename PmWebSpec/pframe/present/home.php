...
<!--                                 </form> -->
                            ...
                            <div class="hovertip">  
                                ...
                                ?>                                       
                                <span class="hovertiptext">Request for analysis directory setup on PKMS</span>
                            </div>
                            <div class="hovertip">    
                                <?php
                                     if(in_array('Download', $user_access['screen_name'])) {
                                       echo '<input class="button" type="submit" name="selection" value="Download" />';
                                     } else {
                                        //echo '<a class="button" href="'. base_url("home/access") .'">Download</a>';
                                        echo '<input class="button" type="submit" name="selection" value="Download" disabled />';
                                     }
                                ?>                 
                                <span class="hovertiptext">DS programmer only: download the specification to PKMS server</span>
                            </div>
                            <div class="hovertip">
                                <?php
