...
<script type="text/javascript" src="<?php echo base_url('assets/js/canvas.js')?>"></script>
	...
	<?php
    	...
    	echo "<tr>";
    	echo "<td>PK Scientist (CP&amp;P)</td>";
    	echo "<td>" .  $pk_scientist .  "</td>";
    	echo "<td>2.1</td>";
    	echo "</tr>";
    		
    	echo "<tr>";
    	echo "<td>Pharmacometric Scientist (CP&amp;P)</td>";
    	echo "<td>" .  $pm_scientist .  "</td>";
    	echo "<td>1, 2, 3, 4</td>";
    	echo "</tr>";
    		
    	echo "<tr>";
    	echo "<td>Statistician and/or Programmer (GBS)</td>";
    	echo "<td>" .  $statistician .  "</td>";
    	echo "<td>2.2</td>";	
    	echo "</tr>";
    		
    	echo "<tr>";
    	echo "<td>Programmer (GBS or CP&amp;P)</td>";
        ...
        echo "<th style='width: 18%;word-wrap: break-word!important;'>level0</th>";
        echo "<th style='width: 18%;word-wrap: break-word!important;'>level1/SDTM</th>";
        echo "<th style='width: 20%;word-wrap: break-word!important;'>level2</th>";
        echo "<th style='width: 30%;word-wrap: break-word!important;'>format</th>";
    	echo "</tr>";	
        ...
        echo "</tr>";
        	...
        	foreach ($flag as $arr) {	
        		...
        		echo "<td>" . htmlspecialchars($arr['flag_comment']) . '</td>';
        		echo "<td>" . htmlspecialchars($arr['flag_notes']) . '</td>';
        		echo "</tr>";	
        	}
