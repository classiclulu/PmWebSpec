...
<br/>
		...
		<div class="container-fuild">
        	<div class="row">
                <div class="col col-md-6 pull-left">
                  <label><b>Your Full Name: (First Last)</b></label><input id="username" name="username" type="text" size="20" value="<?php  echo $fullname; ?>" required />
                </div>
                <div class="col col-md-6 pull-right">
                	<?php 
                		if($user_spec['type'] == 'PPK-NIVO') {
                			      $cname = '';//'BMS-936558';
                		}else {
                			      $cname = '';
                		}
                	?>
                  <label><b>Compound Name: (e.g. BMS-936558, cc-12345)</b></label><input id="cname" name="cname" type="text" size="20"  value="<?php echo $cname; ?>" title="Compound name must start with letter Ex:BMS- and followed by the compound number" oninput="cnameCheck();" required />
                </div>
	...
	<div id="General Information" class="tabcontent">
	    ...
	    <div class="panel container-fluid">
			...
			if($user_spec['type'] == 'PPK-standard' || $user_spec['type'] == 'PPK-ISOP-RELA' || $user_spec['type'] == 'PPK-ISOP-NIVO' || $user_spec['type'] == 'PPK-ISOP-IPI') {
