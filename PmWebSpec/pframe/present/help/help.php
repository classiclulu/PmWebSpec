...
<br/>
	...
	<div id="New" class="tabcontent">
		...
		<center><img src="assets/imgs/help/01.png" width="400" height="300" border="2"></center>
		<br />
		...
		<center><img src="assets/imgs/help/02.png?random" width="600" height="400" border="2"></center>
		<br />
		...
		<center><p>Dataset structure table</p><img src="assets/imgs/help/03.png?random" width="1000" height="500" border="2"></center>
		<center><p>Variable actions</p><img src="assets/imgs/help/04.png?random" width="1000" height="200" border="2"></center>
		<center><p>Optional variable table</p><img src="assets/imgs/help/05.png?random" width="1000" height="500" border="2"></center>
		<br />
		...
		<center><p>Variable actions</p><img src="assets/imgs/help/06.png?random" width="1000" height="500" border="2"></center>
		<center><p>Variable actions</p><img src="assets/imgs/help/07.png?random" width="1000" height="500" border="2"></center>
		<br />
	...
	<div id="Import" class="tabcontent">
		...
		<center><img src="assets/imgs/help/08.png?random" width="1000" height="500" border="2"></center>
		<p>-Select a version ID and click Next to continue.</p>
		<center><img src="assets/imgs/help/09.png?random" width="1000" height="250" border="2"></center>
		<br />
	...
	<div id="Review" class="tabcontent">
		...
		<center><img src="assets/imgs/help/10.png?random" width="1000" height="300" border="2"></center>
	...
	<div id="Export" class="tabcontent">
		...
		<br />
		<p><strong>Step 3. Click Export. The csv file will be downloaded to PKMS directly and the location will be specified after the button is clicked.</strong></p>
	</div>
